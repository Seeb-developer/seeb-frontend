...
export function RoomModal({ isOpen, onClose, rooms = [], loading, error }) {
        ...
        <div className="flex justify-center gap-3 mb-4">
          {Object.keys(groupedRooms).map((type) => (
            <button
              ...
              className={`px-4 py-1 rounded-full text-md font-medium capitalize ${
                activeTab === type
        ...
        <div className="overflow-y-auto flex-grow">
          {loading ? (
            ...
            <p className="text-center text-gray-400">
              No rooms available for {activeTab}.
            </p>
          )}
        </div>
      </div>
